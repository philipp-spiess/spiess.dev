...
export async function GET() {
  ...
  lines.push("Codex at [OpenAI](https://openai.com).")
  lines.push("Prev: [Tailwind Labs](https://tailwindcss.com), [Meta](https://facebook.com), [Sourcegraph](https://sourcegraph.com), [React DOM](https://reactjs.org/).")
  lines.push("")
